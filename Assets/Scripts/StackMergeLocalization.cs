...
namespace StackMerge
{
    ...
    public static class StackMergeLocalization
    {
        ...
        private static readonly Dictionary<string, string> Hungarian = new(StringComparer.Ordinal)
        {
            ...
            ["Boosts base <sprite name=\"chips\" tint=1> income. Early levels give larger gains."] = "Növeli az alap <sprite name=\"chips\" tint=1> bevételt. A korai szintek többet adnak.",
            ...
            ["Shrinks the delay of MOCA and PLAN solvers."] = "Csökkenti a MOCA és PLAN solverek késleltetését.",
            ...
            ["Lowers the frames needed for PPO Normal Mode."] = "Csökkenti a PPO Normál mód frame követelményét.",
            ...
            ["Needs Difficulty L1"] = "Difficulty L1 szükséges",
            ["Needs PPO or Bootcamp L5"] = "PPO vagy Bootcamp L5 szükséges",
            ["Needs Curriculum"] = "Curriculum szükséges",
            ...
            ["Needs Agents"] = "Ügynökök szükséges",
            ...
            ["Open Agents to start the next stage."] = "Nyisd meg az Ügynököket a következő szakaszhoz.",
            ["Unlock COMBO or LOOK solver to open Agents."] = "Oldd fel a COMBO vagy a LOOK solvert az Ügynökök megnyitásához.",
            ["Unlock COMBO or LOOK solver first."] = "Előbb oldd fel a COMBO vagy a LOOK solvert.",
            ["Modifiers Lab"] = "Modok Lab",
            ["Agents Lab"] = "Ügynök Lab",
            //["Needs COMBO/LOOK"] = "COMBO/LOOK szükséges",
            ...
            ["Equip 3 Agents at once"] = "Szerelj fel egyszerre 3 Ügynököt",
            ...
            ["Prestige reset for a total of 15 times"] = "Prestige resetelj összesen 15 alkalommal",
            ["Run PPO once in Normal Mode"] = "Futtasd a PPO-t egyszer Normál Módban",
            ["Reach 100K PPO frames"] = "Érj el 100K PPO frame-et",
            ["Earn 1000 <sprite name=\"insight\" tint=1> in total"] = "Szerezz összesen 1000 <sprite name=\"insight\" tint=1>-ot",
            ["Earn 10K <sprite name=\"insight\" tint=1> in total"] = "Szerezz összesen 10K <sprite name=\"insight\" tint=1>-ot",
            ["Earn 100K <sprite name=\"insight\" tint=1> in total"] = "Szerezz összesen 100K <sprite name=\"insight\" tint=1>-ot",
            ...
            ["Perfectly Reasonable"] = "Teljesen ésszerű",
            ["Full Autopilot"] = "Teljes autopilóta",
            ["Bad Financial Advice"] = "Rossz pénzügyi tanács",
            ["Still Here"] = "Még mindig itt",
            ["One More Run"] = "Még egy run",
            ["See You Again"] = "Viszlát újra",
            ["Perfectly Balanced"] = "Tökéletesen kiegyensúlyozott",
            ["Second Thoughts"] = "Meggondoltad magad",
            ["No Defaults Given"] = "Nincs több alapérték",
            ["Let it cook"] = "Hagyd főni",
            ["Old intelligence"] = "Régi intelligencia",
            ["Remove something big"] = "Törölj valami nagyot",
            ["A very specific reserve"] = "Nagyon pontos tartalék",
            ["Everything buys itself"] = "Minden magát veszi meg",
            ["Questionable first purchase"] = "Kétes első vásárlás",
            ["Stay a while"] = "Maradj még egy kicsit",
            ["Just one more run"] = "Csak még egy run",
            ["Come back often"] = "Gyere vissza gyakran",
            ["Almost perfectly split"] = "Majdnem tökéletes elosztás",
            ["Second thoughts"] = "Hirtelen meggondolás",
            ["No defaults left"] = "Nincs több default",
            ...
            ["Hold exactly 2048 <sprite name=\"token\" tint=1> after a run ends."] = "Legyen pontosan 2048 <sprite name=\"token\" tint=1> nálad egy run végén.",
            ["Have all Auto Buy buttons enabled simultaneously."] = "Legyen az összes Auto Buy gomb egyszerre bekapcsolva.",
            ["Buy the Joker as your first Modifier in a prestige."] = "Vedd meg a Jokert első Módosítóként egy prestige-ben.",
            ["Have 24 hours of lifetime playtime."] = "Legyen 24 óra teljes játékidőd.",
            ["Leave the game open for 2 hours straight."] = "Hagyd nyitva a játékot megszakítás nélkül 2 órán át.",
            ["Exit the game 10 times."] = "Lépj ki a játékból 10 alkalommal.",
            ["Split Compute Allocation exactly 33-33-33-1."] = "Oszd el a Compute Allocationt pontosan 33-33-33-1 arányban.",
            ["Deselect a solver immediately after selecting it."] = "Kapcsolj ki egy solvert közvetlenül a kiválasztása után.",
            ["Modify all parameters of PPO in Tuning."] = "Állítsd át a PPO összes paraméterét a Tuningban.",
            ...
            ["Consecutive merges multiply move income."] = "Az egymást követő merge-ek bevétel szorzót adnak.",
            ["Converts part of the run's score into <sprite name=\"chips\" tint=1>."] = "A run végi pontszám egy része <sprite name=\"chips\" tint=1>-re váltódik.",
            ["Held <sprite name=\"token\" tint=1> pay <sprite name=\"chips\" tint=1> times the √ of the hoard."] = "A tartott <sprite name=\"token\" tint=1>-ek <sprite name=\"chips\" tint=1>-et fizetnek, a készlet √-ével szorozva.",
            ["The currency for Auto restart. Price rises the more <sprite name=\"token\" tint=1> you hold."] = "Az Auto újraindítás fizetőeszköze. Az ára a tartott <sprite name=\"token\" tint=1>-ekkel együtt nő.",
            ["Standard"] = "Normál",
            ["Byte"] = "Bájt",
            ...
            ["Total frame"] = "Összes frame",
            ["Average frame / Prestige"] = "Átlagos frame / Prestige",
            ["Total runs"] = "Összes run",
            ["Total moves"] = "Összes lépés",
            ["Total merges"] = "Összes merge",
            ["PPO knowledge"] = "PPO tudás",
            ["Total playtime"] = "Összes játékidő",
            ...
            ["Rolls out multiple futures, judging each by the surviving board and the peak tier it reaches."] = "Több lehetséges jövőt játszik le, mindegyiket a túlélés és az elért highest alapján ítélve meg.",
            ...
            ["Queue planner. Searches lines through the visible next blocks. Planning depth (3–5) can be tuned for patience vs practicality."] = "Queue-tervező. Következő blokkokon át keres lépéseket. A tervezési mélység (3–5) türelemhez vs gyakorlatiassághoz hangolható.",
            ...
            ["+200% <sprite name=\"chips\" tint=1> from new highest-block rewards."] = "+200% <sprite name=\"chips\" tint=1> az új highest-blokk jutalmakból.",
            ["+200% <sprite name=\"chips\" tint=1> from end-of-run score bonus."] = "+200% <sprite name=\"chips\" tint=1> a run végi pontszám bónuszból.",
            ["Solver move interval is 25% shorter."] = "A solver lépésköze 25%-kal rövidebb.",
            ["+10 <sprite name=\"chips\" tint=1> on every successful placement."] = "+10 <sprite name=\"chips\" tint=1> minden sikeres lerakás után.",
            ["Auto Restart consumes no tokens while this agent is active."] = "Az Auto újraindítás nem fogyaszt tokent, amíg ez az ügynök aktív.",
            ...
            ["MOCA runs permanently about twice as fast. Negative speed tuning on it is also twice as effective."] = "A MOCA véglegesen kb. kétszer gyorsabb. A negatív hangolás is kétszer hatékonyabb.",
            ...
            ["Every hired Agent's bonus effect is 40% stronger per level. Agents become a core engine of faster replays."] = "Minden felbérelt Ügynök bónuszhatása szintenként 40%-kal erősebb. Az Ügynökök a gyorsabb újrajátszások egyik fő motorjává válnak.",
            ["Upgrades, Agents and Modifiers cost 5% less per level, and the Modifiers requirement needs 15% fewer runs & merges per level. At level 5, Datacenter costs are 20% cheaper."] = "A Fejlesztések, Ügynökök és Módosítók szintenként 5%-kal kevesebbe kerülnek. A Módosítók run & merge követelményei szintenként 15%-kal csökkennek. 5. szinten a Datacenter árak 20%-kal olcsóbbak.",
            ...
            ["Auto Restart unlock and 50 tokens remembered."] = "Az Auto újraindítás feloldása és 50 token megőrizve.",
            ["Auto Solve, Auto Restart, tokens, and Solver Tuning remembered."] = "Az Auto megoldás, Auto újraindítás, tokenek és Solver Tuning megőrizve.",
