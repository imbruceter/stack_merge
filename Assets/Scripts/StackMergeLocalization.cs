...
namespace StackMerge
{
    ...
    public static class StackMergeLocalization
    {
        ...
        private static readonly Dictionary<string, string> Hungarian = new(StringComparer.Ordinal)
        {
            ...
            ["Consecutive merges give +1% <sprite name=\"chips\" tint=1> per level."] = "Az egymást követő merge-ek szintenként +1% <sprite name=\"chips\" tint=1>-et adnak.",
            ["The run's final score is converted into +4% <sprite name=\"chips\" tint=1> per level."] = "A run végi pontszám szintenként +4% <sprite name=\"chips\" tint=1>-re váltódik.",
            ["Held <sprite name=\"token\" tint=1> pay +1% <sprite name=\"chips\" tint=1> per level times the square root of the hoard."] = "A tartott <sprite name=\"token\" tint=1>-ek szintenként +1% <sprite name=\"chips\" tint=1>-et fizetnek, a készlet négyzetgyökével szorozva.",
            ["The currency for Auto restart. Pack price rises with the <sprite name=\"token\" tint=1> you hold."] = "Az Auto restart fizetőeszköze. A pack ára a tartott <sprite name=\"token\" tint=1>-ekkel együtt nő.",
            ["Standard"] = "Normál",
            ["Byte"] = "Bájt",
