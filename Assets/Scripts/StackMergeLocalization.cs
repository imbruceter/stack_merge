...
namespace StackMerge
{
    ...
    public static class StackMergeLocalization
    {
        ...
        private static readonly Dictionary<string, string> Hungarian = new(StringComparer.Ordinal)
        {
            ...
            ["Held <sprite name=\"token\" tint=1> pay <sprite name=\"chips\" tint=1> times the square root of the hoard."] = "A tartott <sprite name=\"token\" tint=1>-ek szintenként +1% <sprite name=\"chips\" tint=1>-et fizetnek, a készlet négyzetgyökével szorozva.",
            ["The currency for Auto restart. Price rises the more <sprite name=\"token\" tint=1> you hold."] = "Az Auto restart fizetőeszköze. Az ára a tartott <sprite name=\"token\" tint=1>-ekkel együtt nő.",
            ["Standard"] = "Normál",
            ["Byte"] = "Bájt",
            ...
            ["Queue planner. Searches lines through the visible next blocks. Planning depth (3–5) can be tuned for patience vs practicality."] = "Queue-tervező. Következő blokkokon át keres lépésvonalakat. A tervezési mélység (3–5) türelemhez vs gyakorlatiassághoz hangolható.",
            ...
            ["Upgrades, Agents and Modifiers cost 5% less per level, and the Modifiers requirement needs 15% fewer runs & merges per level. Cheaper, faster shopping shortens every cycle."] = "A Fejlesztések, Ügynökök és Módosítók szintenként 5%-kal kevesebbe kerülnek. A Módosítók run & merge követelményei szintenként 15%-kal csökkennek. Az olcsóbb, gyorsabb vásárlás minden ciklust lerövidít.",
